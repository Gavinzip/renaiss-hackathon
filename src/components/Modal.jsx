        ...
        {open ? (
          <>
            <motion.div
              ...
              role="presentation"
              initial={{ opacity: 0.42, backdropFilter: 'blur(14px)' }}
              animate={{ opacity: 1, backdropFilter: 'blur(14px)' }}
              exit={{
                opacity: 0,
                backdropFilter: 'blur(0px)',
                transition: { duration: reduceMotion ? 0 : 0.24, ease: MOTION_EXIT_EASE },
              }}
              transition={{ duration: reduceMotion ? 0 : 0.2, ease: [0.4, 0, 0.4, 1] }}
              style={{ willChange: 'opacity, backdrop-filter' }}
              onMouseDown={(event) => { if (event.target === event.currentTarget) onClose(); }}
            />
            <div className="modal-layer--linear">
            <motion.section
              ref={panelRef}
              ...
              style={{ borderRadius: 18, willChange: 'transform, opacity' }}
            >
